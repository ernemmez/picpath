    ...
    return (
        isMobile ?
            <div
                ...
                style={{ backgroundImage: `url('${bgImageMobile.src}')`, backgroundSize: 'cover' }}
            >
                <Image
                    src={whiteLogo}
                    alt="PicPath"
                ...
                <div className="ml-8">
                    ...
                    <div className="text-sm text-white">
                        {isLogin ? 'We missed your beautiful views' : 'Be included in the beautiful landscapes'}
                    </div>
                </div>
            </div>
            :
            <div className={classNames("bg-cover lg:w-7/12 lg:h-screen flex flex-col justify-center items-center", {
                ...
                <div className="w-4/10 text-center text-white">
                    ...
                    <div className="w-3/5 m-auto text-base" style={{ textShadow: "2px 1px 0px rgba(0, 0, 0, 0.25)" }}>
